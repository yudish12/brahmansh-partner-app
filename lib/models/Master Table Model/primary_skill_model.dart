...
class PrimarySkillModel {
  ...
  PrimarySkillModel.fromJson(Map<String, dynamic> json) {
    try {
      id = json["id"];
      name = json["name"] ?? '';
      ...
      print('Exception: primary_skill_model.dart.dart - PrimarySkillModel.fromJson(): ' + e.toString());
    }
  }
