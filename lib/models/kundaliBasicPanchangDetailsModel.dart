...
class KundliBasicDetail {
  ...
  String? sunrise;
  String? sunset;
  factory KundliBasicDetail.fromJson(Map<String, dynamic> json) =>
      KundliBasicDetail(
        day: json["day"] ?? 0,
        month: json["month"] ?? 0,
        year: json["year"] ?? 0,
        ...
        lon: json['longitude'] != null
            ...
            : 0.0,
        tzone: json['timezone'] != null
            ? double.parse(json['timezone'].toString())
            : 0.0,
        ayanamsha: json['ayanamsha'] != null
            ? double.parse(json['ayanamsha'].toString())
            : 0.0,
...
class KundliBasicPanchangDetail {
  ...
  factory KundliBasicPanchangDetail.fromJson(Map<String, dynamic> json) =>
      KundliBasicPanchangDetail(
        day: json["day"] ?? "",
        month: json["month"] ?? 0,
        year: json["year"] ?? 0,
...
class KundliPlanetsDetail {
  ...
  factory KundliPlanetsDetail.fromJson(Map<String, dynamic> json) =>
      KundliPlanetsDetail(
        id: json["id"] ?? 0,
        fullDegree: json['fullDegree'] != null
            ? double.parse(json['fullDegree'].toString())
            : 0.0,
        normDegree: json['normDegree'] != null
            ? double.parse(json['normDegree'].toString())
            : 0.0,
        house: json['house'] ?? 0,
...
class KundliBasicPlanetModel {
  ...
  KundliBasicPlanetModel.fromJson(Map<String, dynamic> json) {
    try {
      varnaList = json['varna'] != null
          ? KundliPlanetsDetail.fromJson(json['varna'])
          : KundliPlanetsDetail();
      vashyaList = json["vashya"] != null
          ? KundliPlanetsDetail.fromJson(json['vashya'])
          : KundliPlanetsDetail();
      taraList = json["tara"] != null
          ? KundliPlanetsDetail.fromJson(json['tara'])
          : KundliPlanetsDetail();
      yoniList = json["yoni"] != null
          ? KundliPlanetsDetail.fromJson(json['yoni'])
          : KundliPlanetsDetail();
      maitriList = json["maitri"] != null
          ? KundliPlanetsDetail.fromJson(json['maitri'])
          : KundliPlanetsDetail();
      ganList = json["gan"] != null
          ? KundliPlanetsDetail.fromJson(json['gan'])
          : KundliPlanetsDetail();
      bhakutList = json["bhakut"] != null
          ? KundliPlanetsDetail.fromJson(json['bhakut'])
          : KundliPlanetsDetail();
      nadiList = json["nadi"] != null
          ? KundliPlanetsDetail.fromJson(json['nadi'])
          : KundliPlanetsDetail();
      totalList = json["total"] != null
          ? KundliPlanetsDetail.fromJson(json['total'])
          : KundliPlanetsDetail();
      conclusionList = json["conclusion"] != null
          ? KundliPlanetsDetail.fromJson(json['conclusion'])
          : KundliPlanetsDetail();
    } catch (e) {
      debugPrint('Exception in KundliMatchmodel():$e');
    }
  }
  Map<String, dynamic> toJson() => {
        "varna": varnaList,
...
class GemstoneModel {
  ...
  GemstoneModel.fromJson(Map<String, dynamic> json) {
    try {
      lifeStone = json['LIFE'] != null
          ? GemstoneDetailModel.fromJson(json['LIFE'])
          : GemstoneDetailModel();
      luckyStone = json["LUCKY"] != null
          ? GemstoneDetailModel.fromJson(json['LUCKY'])
          : GemstoneDetailModel();
      fortuneStone = json["BENEFIC"] != null
          ? GemstoneDetailModel.fromJson(json['BENEFIC'])
          : GemstoneDetailModel();
    } catch (e) {
      debugPrint('Exception in GemstoneModel():$e');
    }
  }
  Map<String, dynamic> toJson() => {
        "LIFE": lifeStone,
...
class GemstoneDetailModel {
  ...
  GemstoneDetailModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      debugPrint('Exception in KundliMatchingDetailModel():$e');
    }
  }
...
class VimshattariModel {
  ...
  Map<String, dynamic> toJson() =>
      {"planet": planet, "start": start, "end": end, "planet_id": planetId};
}

class YoginiModel {
  YoginiModel({this.planet, this.start, this.end, this.planetId});
  ...
  YoginiModel.fromJson(Map<String, dynamic> json) {
    try {
      planetId = json["planet_id"] ?? 0;
      planet = json["planet"] ?? "";
      start = json["start"] ?? "";
