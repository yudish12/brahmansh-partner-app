...
class SearchBlogScreen extends StatelessWidget {
  ...
  final AstrologyBlogController blogController =
      ...
      child: Scaffold(
          ...
          title: GetBuilder<AstrologyBlogController>(builder: (b) {
            return TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: tr('Search by Blog Title'),
        ...
        body: GetBuilder<AstrologyBlogController>(builder: (blogController) {
          return blogController.astrologySearchBlogs.isEmpty
              ? Center(
                  child: const Text('Blogs not found').tr(),
                )
              : ListView.builder(
                    ...
                    return GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: blogController
                                          ...
                                          : blogController.astrologyBlogs[index]
                                                          .extension ==
                                                      'mp4' ||
                                                  blogController
                          ...
                          blogController.isMoreDataAvailableForSearch == true &&
