              ...
              children: [
                    ...
                    children: [
                      Expanded(
                        child: StreamBuilder<
                            ...
                            stream: astrologerAssistantChatController
                                .getChatMessages(
                                  ...
                                  return ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ChatMessageModel message =
                                            messageList[index];
                                        astrologerAssistantChatController.isMe =
                                            message.userId1 ==
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: GetBuilder<AstrologerAssistantChatController>(
                        builder: (astrologerAssistantChatController) {
                      return Row(
                        children: [
                          Expanded(
