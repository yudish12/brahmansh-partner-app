...
import 'package:brahmanshtalk/controllers/HomeController/astrology_blog_controller.dart';
import 'package:brahmanshtalk/views/HomeScreen/FloatingButton/AstroBlog/astrology_blog_detil_screen.dart';
import 'package:brahmanshtalk/views/HomeScreen/search_blog_screen.dart';
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, index) {
                      return GestureDetector(
                        onTap: () async {
                          global.showOnlyLoaderDialog();
                          await blogController.incrementBlogViewer(
                              blogController.astrologyBlogs[index].id);
                          blogController.blogVideo(
                              blogController.astrologyBlogs[index].blogImage);
                          global.hideLoader();
                          Get.to(() => AstrologyBlogDetailScreen(
                                image: blogController
                                    .astrologyBlogs[index].blogImage,
                                title:
                                    blogController.astrologyBlogs[index].title,
                                description: blogController
                                        .astrologyBlogs[index].description ??
                                    "",
                                extension: blogController
                                        .astrologyBlogs[index].extension ??
                                    "",
                                videoPlayerController:
                                    blogController.videoPlayerController!,
                              ));
                        },
                        child: Column(
                          children: [
                                            ...
                                            : blogController
                                                ...
                                                ? Stack(
                                                    ...
                                                    children: [
                                                      CachedNetworkImage(
                                                        imageUrl:
                                                            '${blogController.astrologyBlogs[index].previewImage}',
                            ...
                            blogController.isMoreDataAvailable == true &&
                                    !blogController.isAllDataLoaded &&
                                    blogController.astrologyBlogs.length - 1 ==
                                        index
